...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AProject/AProject.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/A_Category/A_Category.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BProject/BProject.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/C_Category/C_Category.framework"
